<div class="hero u-flex u-flex--center">
	<div class="hero__left">
		<img src="/digidence/public/images/hero-1.png" alt="">
		<img src="/digidence/public/images/hero-2.png" alt="">
		<img src="/digidence/public/images/hero-3.png" alt="">
	</div>
...
<section class="l-index__works js-scroll-activate">
	...
	<ul id="js-works-slider">
		<?php for($i = 1;$i <= 5;$i++) { ?>
		<li>
			<img src="/digidence/public/images/works-dummy.png" alt="">
		</li>
		<?php } ?>
	</ul>
</section>
...
<aside class="l-index__contact js-scroll-activate" id="js-contact">
	<div class="contact">
		...
		<a href="https://digidence.net">
			<img src="/digidence/public/images/letter-d.svg" class="contact__logo">
		</a>
	</div>
